...
jQuery(document).ready(function () {
    jQuery('body').on('click', '.product-view-area ul li a',function () {
    ...
    function changeImage(e) {
        activeImage = document.querySelector(".product-view-image .active");
    ...
    jQuery('body').on('click', '.image-list img', changeImage);
    jQuery('body').on('click', 'a.toggle-nav', toggleNavigation);
