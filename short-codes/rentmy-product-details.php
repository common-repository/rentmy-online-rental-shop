...
<!--                    --><?php //if ($GLOBALS['store_config']['datetime']['exact_start_date'] != 1 || $GLOBALS['store_config']['datetime']['exact_start_date'] != '1') { ?>
                                ...
                                <div class="price-options" style="display: none;">
                                    ...
                                    <?php $counter = 0; foreach ($prices['rent'] as $i => $rents) { ?>
                                        <label class="radio-container">
                                            ...
                                            <?php $duration_label = !empty($rents['duration'])?' /' . $rents['duration'] . ' ' .  $GLOBALS['RentMy']->format_price_label($rents['duration'],  $rents['label']):''; ?>
                                            <?php echo $GLOBALS['RentMy']::currency($rents['price']) . $duration_label ; ?>
                                            <span class="checkmark"></span>
                                        </label>
                                    <?php $counter++; } ?>
                                    <?php } else{
                    ...
                    <?php } else { ?>
                        ...
                        <div class="price-options" style="display: none;">
                            <h4>
                                <?php echo $GLOBALS['store_text']['product_details']['exact_due_date'] ?? 'Due Date';?> <?php echo date('m/d/Y', strtotime(trim($rent_my_product_details['rent_end']))); ?>
                            </h4>
                        </div>
                    ...
                    <div class="variants">
                        ...
                        foreach ($rent_my_product_details['variant_set_list'] as $i => $variantSets) { ?>
                            <div class="form-group variantSets">
                                ...
                                <select class="mb-0" name="variantSets[]" data-index="<?php echo $i + 1; ?>"
                    ...
                    <div class="rm-delivery-option">
                        <h6 class="mb-2 mt-0"><?php echo $GLOBALS['store_text']['product_details']['lbl_delivery_option'] ?? 'Select Delivery Option';?></h6>
                        <ul>
                            ...
                            <div class="exact-date-wrapper" style="display: none">
                                ...
                                <div class="quantity pt-4">
                                    ...
                                    <div class="form-group duration_box">
                                        <label><?php echo $GLOBALS['store_text']['product_details']['exact_select_duration'] ?? 'Select Duration';?>:</label>
                                        <select class="form-control rentmy-duration-component"
                                                name="duration"
                                                id="duration"
                                                >
                                                ...
                                                <?php if (!empty($duration['times'])) : ?>
                                                    ...
                                                    <div class="form-group time-selection time-selection-<?php echo $duration['id'] ?>" style="display: <?php echo ($i == 0) ? 'block' : 'none' ?>">
                                                        ...
                                                        <select
                                                            ...
                                                            class="form-control timeButton rentmy-duration-component"
                                                            name="time"
...
<script>
        jQuery('.duration_box select').on('change', function (e) {
            let id = jQuery(e.target).find('option:selected').data('id');
            jQuery('.time-selection').hide();
            jQuery('.time-selection-' + id ).show();
            jQuery('.timeButton option').prop('selected', false);
        });
</script>
                                    ...
                                    <div class="quantity pt-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control rentmy-duration-component" name="exact_time"
                                                    id="exact_time">
                                                <option value=""><?php echo $GLOBALS['store_text']['product_details']['exact_select_duration_placeholder'] ?? '-Select-';?></option>
                                            </select>
                                        </div>
                                    </div>
                                <?php endif; ?>
            ...
            <?php if (!empty($rent_my_product_details['related_products'])): ?>
                ...
                <div class='rentmy-product-list related-producst-list'>
                    <div class="related-product-title">
                        <h4><?php echo $GLOBALS['store_text']['product_details']['related_title'] ?? 'Related Product';?></h4>
                    </div>
                    <div class='products'>
